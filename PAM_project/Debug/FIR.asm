...
;	C:\ti\ccsv6\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\bacon\\AppData\\Local\\Temp\\2535612 
	.sect	".text"
	.global	_myFir
...
$C$DW$8	.dwtag  DW_TAG_subprogram, DW_AT_name("myFir")
	...
	.dwattr $C$DW$8, DW_AT_TI_begin_line(0x07)
	.dwattr $C$DW$8, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$8, DW_AT_TI_max_frame_size(0x12)
	.dwpsn	file "../FIR.c",line 13,column 1,is_stmt,address _myFir
...
$C$DW$21	.dwtag  DW_TAG_variable, DW_AT_name("k")
	...
	.dwattr $C$DW$21, DW_AT_location[DW_OP_bregx 0x24 12]
        ...
        MOV XAR1, dbl(*SP(#2))
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../FIR.c",line 14,column 10,is_stmt
        MOV #0, *SP(#10) ; |14| 
	.dwpsn	file "../FIR.c",line 15,column 10,is_stmt
        MOV #0, *SP(#11) ; |15| 
	.dwpsn	file "../FIR.c",line 16,column 10,is_stmt
        MOV #0, *SP(#12) ; |16| 
	.dwpsn	file "../FIR.c",line 19,column 6,is_stmt
        MOV #0, *SP(#10) ; |19| 
	.dwpsn	file "../FIR.c",line 19,column 13,is_stmt
        MOV dbl(*SP(#6)), AC0 ; |19| 
        MOV *SP(#10), AC1 ; |19| 
        CMP AC1 >= AC0, TC1 ; |19| 
        BCC $C$L6,TC1 ; |19| 
...
$C$DW$23	.dwtag  DW_TAG_variable, DW_AT_name("result")
	...
	.dwpsn	file "../FIR.c",line 21,column 11,is_stmt
        MOV #0, AC0 ; |21| 
        OR #0x8000, AC0, AC0 ; |21| 
        MOV AC0, dbl(*SP(#14)) ; |21| 
	.dwpsn	file "../FIR.c",line 23,column 3,is_stmt
        MOV dbl(*SP(#0)), XAR3
        MOV *SP(#10), T0 ; |23| 
        MOV dbl(*SP(#4)), XAR2
        MOV *AR3(T0), *AR2 ; |23| 
	.dwpsn	file "../FIR.c",line 26,column 7,is_stmt
        MOV #0, *SP(#11) ; |26| 
	.dwpsn	file "../FIR.c",line 26,column 14,is_stmt
        MOV *SP(#11), AC1 ; |26| 
        MOV dbl(*SP(#8)), AC0 ; |26| 
        CMP AC1 >= AC0, TC1 ; |26| 
        BCC $C$L3,TC1 ; |26| 
...
$C$L2:    
$C$DW$L$_myFir$3$B:
	.dwpsn	file "../FIR.c",line 28,column 4,is_stmt
        MOV *SP(#11), AR1 ; |28| 
        MOV dbl(*SP(#4)), XAR3
        MOV dbl(*SP(#2)), XAR2
        MOV AR1, T0

        MOV dbl(*SP(#14)), AC0 ; |28| 
||      BSET ST1_SATD

        AADD AR1, AR3 ; |28| 
||      BSET ST1_FRCT

        MACM *AR3, *AR2(T0), AC0, AC0 ; |28| 
        MOV AC0, dbl(*SP(#14)) ; |28| 
	.dwpsn	file "../FIR.c",line 26,column 22,is_stmt
        BCLR ST1_SATD
        ADD #1, *SP(#11) ; |26| 
	.dwpsn	file "../FIR.c",line 26,column 14,is_stmt
        MOV *SP(#11), AC1 ; |26| 
...
$C$L3:    
$C$DW$L$_myFir$4$B:
	.dwpsn	file "../FIR.c",line 31,column 12,is_stmt
        MOV dbl(*SP(#8)), AC0 ; |31| 
        SUB #1, AC0 ; |31| 
        MOV AC0, *SP(#12) ; |31| 
	.dwpsn	file "../FIR.c",line 31,column 24,is_stmt
        MOV AC0, AR1
        BCC $C$L5,AR1 <= #0 ; |31| 
                                        ; branchcc occurs ; |31| 
$C$DW$L$_myFir$4$E:
$C$L4:    
$C$DW$L$_myFir$5$B:
	.dwpsn	file "../FIR.c",line 32,column 10,is_stmt
        MOV dbl(*SP(#4)), XAR3
        MOV dbl(*SP(#4)), XAR2
        MOV AR1, T0
        SUB #1, T0 ; |32| 
        AADD AR1, AR3 ; |32| 
        MOV *AR2(T0), *AR3 ; |32| 
	.dwpsn	file "../FIR.c",line 31,column 31,is_stmt
        SUB #1, *SP(#12) ; |31| 
	.dwpsn	file "../FIR.c",line 31,column 24,is_stmt
        MOV *SP(#12), AR1 ; |31| 
        BCC $C$L4,AR1 > #0 ; |31| 
...
$C$L5:    
$C$DW$L$_myFir$6$B:
	.dwpsn	file "../FIR.c",line 35,column 6,is_stmt
        MOV dbl(*SP(#4)), XAR3
        MOV #0, *AR3 ; |35| 
	.dwpsn	file "../FIR.c",line 37,column 6,is_stmt
        MOV *SP(#10), T0 ; |37| 
        MOV dbl(*SP(#0)), XAR3
        MOV dbl(*SP(#14)), AC0 ; |37| 
        MOV HI(AC0), *AR3(T0) ; |37| 
	.dwendtag $C$DW$22

	.dwpsn	file "../FIR.c",line 19,column 21,is_stmt
        ADD #1, *SP(#10) ; |19| 
	.dwpsn	file "../FIR.c",line 19,column 13,is_stmt
        MOV *SP(#10), AC1 ; |19| 
        MOV dbl(*SP(#6)), AC0 ; |19| 
        ...
        BCC $C$L1,TC1 ; |19| 
                                        ; branchcc occurs ; |19| 
$C$DW$L$_myFir$6$E:
	.dwpsn	file "../FIR.c",line 40,column 1,is_stmt
$C$L6:    
        AADD #17, SP
	.dwcfi	cfa_offset, 1
        BCLR ST1_FRCT
...
$C$DW$25	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$25, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L1:1:1717080075")
	.dwattr $C$DW$25, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$25, DW_AT_TI_begin_line(0x13)
	.dwattr $C$DW$25, DW_AT_TI_end_line(0x26)
...
$C$DW$29	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$29, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L2:2:1717080075")
	.dwattr $C$DW$29, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$29, DW_AT_TI_begin_line(0x1a)
	.dwattr $C$DW$29, DW_AT_TI_end_line(0x1d)
...
$C$DW$31	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$31, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L4:2:1717080075")
	.dwattr $C$DW$31, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$31, DW_AT_TI_begin_line(0x1f)
	.dwattr $C$DW$31, DW_AT_TI_end_line(0x21)
...
$C$DW$33	.dwtag  DW_TAG_subprogram, DW_AT_name("myFir2")
	...
	.dwattr $C$DW$33, DW_AT_TI_begin_line(0x2a)
	.dwattr $C$DW$33, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$33, DW_AT_TI_max_frame_size(0x12)
	.dwpsn	file "../FIR.c",line 48,column 1,is_stmt,address _myFir2
...
$C$DW$46	.dwtag  DW_TAG_variable, DW_AT_name("k")
	...
	.dwattr $C$DW$46, DW_AT_location[DW_OP_bregx 0x24 12]
        ...
        MOV XAR1, dbl(*SP(#2))
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../FIR.c",line 49,column 10,is_stmt
        MOV #0, *SP(#10) ; |49| 
	.dwpsn	file "../FIR.c",line 50,column 10,is_stmt
        MOV #0, *SP(#11) ; |50| 
	.dwpsn	file "../FIR.c",line 51,column 10,is_stmt
        MOV #0, *SP(#12) ; |51| 
	.dwpsn	file "../FIR.c",line 54,column 6,is_stmt
        MOV #0, *SP(#10) ; |54| 
	.dwpsn	file "../FIR.c",line 54,column 13,is_stmt
        MOV dbl(*SP(#6)), AC0 ; |54| 
        MOV *SP(#10), AC1 ; |54| 
        CMP AC1 >= AC0, TC1 ; |54| 
        BCC $C$L12,TC1 ; |54| 
...
$C$DW$48	.dwtag  DW_TAG_variable, DW_AT_name("result")
	...
	.dwpsn	file "../FIR.c",line 56,column 11,is_stmt
        MOV #0, AC0 ; |56| 
        OR #0x8000, AC0, AC0 ; |56| 
        MOV AC0, dbl(*SP(#14)) ; |56| 
	.dwpsn	file "../FIR.c",line 57,column 3,is_stmt
        MOV dbl(*SP(#0)), XAR3
        MOV *SP(#10), T0 ; |57| 
        MOV dbl(*SP(#4)), XAR2
        MOV *AR3(T0), *AR2 ; |57| 
	.dwpsn	file "../FIR.c",line 58,column 3,is_stmt
        MOV *SP(#10), T0 ; |58| 
        ADD #1, T0 ; |58| 
        MOV dbl(*SP(#0)), XAR3
        MOV *AR3(T0), AR1 ; |58| 
        MOV dbl(*SP(#4)), XAR3
        MOV AR1, *AR3(short(#1)) ; |58| 
	.dwpsn	file "../FIR.c",line 61,column 7,is_stmt
        MOV #0, *SP(#11) ; |61| 
	.dwpsn	file "../FIR.c",line 61,column 14,is_stmt
        MOV *SP(#11), AC1 ; |61| 
        MOV dbl(*SP(#8)), AC0 ; |61| 
        CMP AC1 >= AC0, TC1 ; |61| 
        BCC $C$L9,TC1 ; |61| 
...
$C$L8:    
$C$DW$L$_myFir2$3$B:
	.dwpsn	file "../FIR.c",line 63,column 4,is_stmt
        MOV *SP(#11), AR1 ; |63| 
        MOV dbl(*SP(#4)), XAR3
        MOV dbl(*SP(#2)), XAR2
        MOV AR1, T0

        MOV dbl(*SP(#14)), AC0 ; |63| 
||      BSET ST1_SATD

        AADD AR1, AR3 ; |63| 
||      BSET ST1_FRCT

        MACM *AR3, *AR2(T0), AC0, AC0 ; |63| 
        MOV AC0, dbl(*SP(#14)) ; |63| 
	.dwpsn	file "../FIR.c",line 61,column 22,is_stmt
        BCLR ST1_SATD
        ADD #1, *SP(#11) ; |61| 
	.dwpsn	file "../FIR.c",line 61,column 14,is_stmt
        MOV *SP(#11), AC1 ; |61| 
...
$C$L9:    
$C$DW$L$_myFir2$4$B:
	.dwpsn	file "../FIR.c",line 66,column 12,is_stmt
        MOV dbl(*SP(#8)), AC0 ; |66| 
        SUB #1, AC0 ; |66| 
        MOV AC0, *SP(#12) ; |66| 
	.dwpsn	file "../FIR.c",line 66,column 24,is_stmt
        MOV AC0, AR1
        BCC $C$L11,AR1 <= #0 ; |66| 
                                        ; branchcc occurs ; |66| 
$C$DW$L$_myFir2$4$E:
$C$L10:    
$C$DW$L$_myFir2$5$B:
	.dwpsn	file "../FIR.c",line 67,column 10,is_stmt
        MOV dbl(*SP(#4)), XAR3
        MOV dbl(*SP(#4)), XAR2
        MOV AR1, T0
        SUB #1, T0 ; |67| 
        AADD AR1, AR3 ; |67| 
        MOV *AR2(T0), *AR3 ; |67| 
	.dwpsn	file "../FIR.c",line 66,column 31,is_stmt
        SUB #1, *SP(#12) ; |66| 
	.dwpsn	file "../FIR.c",line 66,column 24,is_stmt
        MOV *SP(#12), AR1 ; |66| 
        BCC $C$L10,AR1 > #0 ; |66| 
...
$C$L11:    
$C$DW$L$_myFir2$6$B:
	.dwpsn	file "../FIR.c",line 70,column 6,is_stmt
        MOV dbl(*SP(#4)), XAR3
        MOV #0, *AR3 ; |70| 
	.dwpsn	file "../FIR.c",line 71,column 6,is_stmt
        MOV *SP(#10), T0 ; |71| 
        MOV dbl(*SP(#0)), XAR3
        MOV dbl(*SP(#14)), AC0 ; |71| 
        MOV HI(AC0), *AR3(T0) ; |71| 
	.dwendtag $C$DW$47

	.dwpsn	file "../FIR.c",line 54,column 21,is_stmt
        ADD #2, *SP(#10) ; |54| 
	.dwpsn	file "../FIR.c",line 54,column 13,is_stmt
        MOV *SP(#10), AC1 ; |54| 
        MOV dbl(*SP(#6)), AC0 ; |54| 
        ...
        BCC $C$L7,TC1 ; |54| 
                                        ; branchcc occurs ; |54| 
$C$DW$L$_myFir2$6$E:
	.dwpsn	file "../FIR.c",line 74,column 1,is_stmt
$C$L12:    
        AADD #17, SP
	.dwcfi	cfa_offset, 1
        BCLR ST1_FRCT
...
$C$DW$50	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$50, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L7:1:1717080075")
	.dwattr $C$DW$50, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$50, DW_AT_TI_begin_line(0x36)
...
$C$DW$54	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$54, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L8:2:1717080075")
	.dwattr $C$DW$54, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$54, DW_AT_TI_begin_line(0x3d)
	.dwattr $C$DW$54, DW_AT_TI_end_line(0x40)
...
$C$DW$56	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$56, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L10:2:1717080075")
	.dwattr $C$DW$56, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$56, DW_AT_TI_begin_line(0x42)
	.dwattr $C$DW$56, DW_AT_TI_end_line(0x44)
...
$C$DW$58	.dwtag  DW_TAG_subprogram, DW_AT_name("maintainDL")
	...
	.dwattr $C$DW$58, DW_AT_TI_begin_line(0x4d)
	.dwattr $C$DW$58, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$58, DW_AT_TI_max_frame_size(0x0c)
	.dwpsn	file "../FIR.c",line 77,column 96,is_stmt,address _maintainDL
...
$C$DW$66	.dwtag  DW_TAG_variable, DW_AT_name("j")
	...
	.dwattr $C$DW$66, DW_AT_location[DW_OP_bregx 0x24 8]
        ...
        MOV XAR1, dbl(*SP(#2))
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../FIR.c",line 79,column 10,is_stmt
        MOV #0, AC0 ; |79| 
        MOV AC0, dbl(*SP(#6)) ; |79| 
	.dwpsn	file "../FIR.c",line 79,column 17,is_stmt
        MOV dbl(*SP(#6)), AC1 ; |79| 
        MOV dbl(*SP(#4)), AC0 ; |79| 
        CMP AC1 >= AC0, TC1 ; |79| 
        BCC $C$L16,TC1 ; |79| 
...
$C$DW$L$_maintainDL$2$B:
	.dwpsn	file "../FIR.c",line 80,column 9,is_stmt
        MOV dbl(*SP(#0)), XAR3
        MOV *SP(#7), T0 ; |80| 
        MOV dbl(*SP(#2)), XAR2
        MOV *AR3(T0), *AR2 ; |80| 
	.dwpsn	file "../FIR.c",line 82,column 14,is_stmt
        MOV #29, AC0 ; |82| 
        MOV AC0, dbl(*SP(#8)) ; |82| 
	.dwpsn	file "../FIR.c",line 82,column 32,is_stmt
        MOV dbl(*SP(#8)), AC0 ; |82| 
        BCC $C$L15,AC0 <= #0 ; |82| 
                                        ; branchcc occurs ; |82| 
...
$C$DW$L$_maintainDL$3$B:
	.dwpsn	file "../FIR.c",line 83,column 13,is_stmt
        MOV *SP(#9), AR1 ; |83| 
        MOV dbl(*SP(#2)), XAR3
        MOV dbl(*SP(#2)), XAR2
        MOV dbl(*SP(#8)), AC0 ; |83| 
        ...
        AADD AR1, AR3 ; |83| 
        MOV *AR2(T0), *AR3 ; |83| 
	.dwpsn	file "../FIR.c",line 82,column 39,is_stmt
        MOV dbl(*SP(#8)), AC0 ; |82| 
        SUB #1, AC0 ; |82| 
        MOV AC0, dbl(*SP(#8)) ; |82| 
	.dwpsn	file "../FIR.c",line 82,column 32,is_stmt
...
$C$DW$L$_maintainDL$4$B:
	.dwpsn	file "../FIR.c",line 85,column 9,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #0, *AR3 ; |85| 
	.dwpsn	file "../FIR.c",line 79,column 32,is_stmt
        MOV dbl(*SP(#6)), AC0 ; |79| 
        ADD #1, AC0 ; |79| 
        MOV AC0, dbl(*SP(#6)) ; |79| 
	.dwpsn	file "../FIR.c",line 79,column 17,is_stmt
...
$C$DW$L$_maintainDL$4$E:
	.dwpsn	file "../FIR.c",line 87,column 1,is_stmt
$C$L16:    
        AADD #11, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$68	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$68, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L13:1:1717080075")
	.dwattr $C$DW$68, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$68, DW_AT_TI_begin_line(0x4f)
...
$C$DW$71	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$71, DW_AT_name("C:\Users\bacon\OneDrive\workspace_v6_1\PAM_project\Debug\FIR.asm:$C$L14:2:1717080075")
	.dwattr $C$DW$71, DW_AT_TI_begin_file("../FIR.c")
	.dwattr $C$DW$71, DW_AT_TI_begin_line(0x52)
	.dwattr $C$DW$71, DW_AT_TI_end_line(0x54)
$C$DW$72	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$58, DW_AT_TI_end_line(0x57)
