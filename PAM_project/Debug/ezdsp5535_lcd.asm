...
;	C:\ti\ccsv6\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\golan\\AppData\\Local\\Temp\\7102812 
	.sect	".text"
...
$C$DW$30	.dwtag  DW_TAG_variable, DW_AT_name("cmd")
	...
	.dwattr $C$DW$30, DW_AT_location[DW_OP_bregx 0x24 4]
        MOV T0, *SP(#2) ; |79| 
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../ezdsp5535_lcd.c",line 82,column 9,is_stmt
        MOV #0, *SP(#3) ; |82| 
...
$C$DW$L$_EZDSP5535_OSD9616_multiSend$2$B:
	.dwpsn	file "../ezdsp5535_lcd.c",line 84,column 6,is_stmt
        ...
        AADD AR1, AR3 ; |84| 
        MOV *AR2(T0), *AR3 ; |84| 
	.dwpsn	file "../ezdsp5535_lcd.c",line 82,column 19,is_stmt
        ADD #1, *SP(#3) ; |82| 
	.dwpsn	file "../ezdsp5535_lcd.c",line 82,column 13,is_stmt
        MOV *SP(#2), AR1 ; |82| 
        MOV *SP(#3), AR2 ; |82| 
...
$C$DW$34	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$34, DW_AT_name("C:\Users\golan\Downloads\ezdsp5535_v1_spring2024\projects\pam\Debug\ezdsp5535_lcd.asm:$C$L1:1:1715535454")
	.dwattr $C$DW$34, DW_AT_TI_begin_file("../ezdsp5535_lcd.c")
...
$C$DW$36	.dwtag  DW_TAG_subprogram, DW_AT_name("EZDSP5535_OSD9616_init")
	...
	.dwattr $C$DW$36, DW_AT_TI_begin_file("../ezdsp5535_lcd.c")
...
$C$DW$59	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$59, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$36, DW_AT_TI_end_file("../ezdsp5535_lcd.c")
...
$C$DW$60	.dwtag  DW_TAG_subprogram, DW_AT_name("EZDSP5535_OSD9616_printLetter")
	...
	.dwattr $C$DW$60, DW_AT_TI_begin_file("../ezdsp5535_lcd.c")
...
$C$DW$74	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$74, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$60, DW_AT_TI_end_file("../ezdsp5535_lcd.c")
