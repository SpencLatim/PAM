...
;* Date/Time created: Tue May 14 15:42:48 2024                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../FFT/rtGetInf.c")
...
;	C:\ti\ccsv6\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\golan\\AppData\\Local\\Temp\\0604812 
	.sect	".text"
	.global	_rtGetInf

$C$DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("rtGetInf")
	...
	.dwattr $C$DW$1, DW_AT_TI_begin_file("../FFT/rtGetInf.c")
	.dwattr $C$DW$1, DW_AT_TI_begin_line(0x1f)
	.dwattr $C$DW$1, DW_AT_TI_begin_column(0x08)
	.dwattr $C$DW$1, DW_AT_TI_max_frame_size(0x0a)
	.dwpsn	file "../FFT/rtGetInf.c",line 32,column 1,is_stmt,address _rtGetInf

	.dwfde $C$DW$CIE, _rtGetInf
;*******************************************************************************
;* FUNCTION NAME: rtGetInf                                                     *
;*                                                                             *
...
_rtGetInf:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-9, SP
	.dwcfi	cfa_offset, 10
$C$DW$2	.dwtag  DW_TAG_variable, DW_AT_name("bitsPerReal")
...
$C$DW$3	.dwtag  DW_TAG_variable, DW_AT_name("inf")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_inf")
	.dwattr $C$DW$3, DW_AT_type(*$C$DW$T$24)
	.dwattr $C$DW$3, DW_AT_location[DW_OP_bregx 0x24 2]
	.dwpsn	file "../FFT/rtGetInf.c",line 33,column 10,is_stmt
        MOV #32, *SP(#0) ; |33| 
	.dwpsn	file "../FFT/rtGetInf.c",line 34,column 10,is_stmt
        MOV dbl(*($C$FL1)), AC0 ; |34| 
        MOV AC0, dbl(*SP(#2)) ; |34| 
	.dwpsn	file "../FFT/rtGetInf.c",line 35,column 3,is_stmt
        CMP *SP(#0) == #32, TC1 ; |35| 
        BCC $C$L1,!TC1 ; |35| 
                                        ; branchcc occurs ; |35| 
	.dwpsn	file "../FFT/rtGetInf.c",line 36,column 5,is_stmt
$C$DW$4	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$4, DW_AT_low_pc(0x00)
	.dwattr $C$DW$4, DW_AT_name("_rtGetInfF")
	.dwattr $C$DW$4, DW_AT_TI_call
        CALL #_rtGetInfF ; |36| 
                                        ; call occurs [#_rtGetInfF] ; |36| 
        MOV AC0, dbl(*SP(#2)) ; |36| 
	.dwpsn	file "../FFT/rtGetInf.c",line 37,column 3,is_stmt
        B $C$L2   ; |37| 
                                        ; branch occurs ; |37| 
$C$L1:    

$C$DW$5	.dwtag  DW_TAG_lexical_block, DW_AT_low_pc(0x00), DW_AT_high_pc(0x00)
$C$DW$6	.dwtag  DW_TAG_variable, DW_AT_name("tmpVal")
	...
	.dwpsn	file "../FFT/rtGetInf.c",line 43,column 5,is_stmt
        MOV #32752 << #16, AC0 ; |43| 
        MOV AC0, dbl(*SP(#4)) ; |43| 
	.dwpsn	file "../FFT/rtGetInf.c",line 44,column 5,is_stmt
        MOV #0, AC0 ; |44| 
        MOV AC0, dbl(*SP(#6)) ; |44| 
	.dwpsn	file "../FFT/rtGetInf.c",line 45,column 5,is_stmt
        MOV dbl(*SP(#4)), AC0 ; |45| 
        MOV AC0, dbl(*SP(#2)) ; |45| 
	.dwendtag $C$DW$5

$C$L2:    
	.dwpsn	file "../FFT/rtGetInf.c",line 48,column 3,is_stmt
	.dwpsn	file "../FFT/rtGetInf.c",line 49,column 1,is_stmt
        AADD #9, SP
	.dwcfi	cfa_offset, 1
$C$DW$7	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$7, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$1, DW_AT_TI_end_file("../FFT/rtGetInf.c")
...
$C$DW$8	.dwtag  DW_TAG_subprogram, DW_AT_name("rtGetInfF")
...
_rtGetInfF:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-3, SP
	.dwcfi	cfa_offset, 4
$C$DW$9	.dwtag  DW_TAG_variable, DW_AT_name("infF")
	...
	.dwpsn	file "../FFT/rtGetInf.c",line 58,column 3,is_stmt
        MOV #32640 << #16, AC0 ; |58| 
        MOV AC0, dbl(*SP(#0)) ; |58| 
	.dwpsn	file "../FFT/rtGetInf.c",line 59,column 3,is_stmt
        MOV dbl(*SP(#0)), AC0 ; |59| 
	.dwpsn	file "../FFT/rtGetInf.c",line 60,column 1,is_stmt
        AADD #3, SP
	.dwcfi	cfa_offset, 1
$C$DW$10	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$10, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$8, DW_AT_TI_end_file("../FFT/rtGetInf.c")
...
$C$DW$11	.dwtag  DW_TAG_subprogram, DW_AT_name("rtGetMinusInf")
	...
	.dwattr $C$DW$11, DW_AT_TI_begin_file("../FFT/rtGetInf.c")
	...
	.dwpsn	file "../FFT/rtGetInf.c",line 67,column 1,is_stmt,address _rtGetMinusInf

	.dwfde $C$DW$CIE, _rtGetMinusInf
;*******************************************************************************
;* FUNCTION NAME: rtGetMinusInf                                                *
;*                                                                             *
;*   Function Uses Regs : AC0,AC0,SP,TC1,M40,SATA,SATD,RDM,FRCT,SMUL           *
;*   Stack Frame        : Compact (No Frame Pointer, w/ debug)                 *
;*   Total Frame Size   : 10 words                                             *
...
_rtGetMinusInf:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-9, SP
	.dwcfi	cfa_offset, 10
$C$DW$12	.dwtag  DW_TAG_variable, DW_AT_name("bitsPerReal")
...
$C$DW$13	.dwtag  DW_TAG_variable, DW_AT_name("minf")
	...
	.dwpsn	file "../FFT/rtGetInf.c",line 68,column 10,is_stmt
        MOV #32, *SP(#0) ; |68| 
	.dwpsn	file "../FFT/rtGetInf.c",line 69,column 10,is_stmt
        MOV dbl(*($C$FL1)), AC0 ; |69| 
        MOV AC0, dbl(*SP(#2)) ; |69| 
	.dwpsn	file "../FFT/rtGetInf.c",line 70,column 3,is_stmt
        CMP *SP(#0) == #32, TC1 ; |70| 
        BCC $C$L3,!TC1 ; |70| 
                                        ; branchcc occurs ; |70| 
	.dwpsn	file "../FFT/rtGetInf.c",line 71,column 5,is_stmt
$C$DW$14	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$14, DW_AT_low_pc(0x00)
	.dwattr $C$DW$14, DW_AT_name("_rtGetMinusInfF")
	.dwattr $C$DW$14, DW_AT_TI_call
        CALL #_rtGetMinusInfF ; |71| 
                                        ; call occurs [#_rtGetMinusInfF] ; |71| 
        MOV AC0, dbl(*SP(#2)) ; |71| 
	.dwpsn	file "../FFT/rtGetInf.c",line 72,column 3,is_stmt
        B $C$L4   ; |72| 
                                        ; branch occurs ; |72| 
$C$L3:    

$C$DW$15	.dwtag  DW_TAG_lexical_block, DW_AT_low_pc(0x00), DW_AT_high_pc(0x00)
$C$DW$16	.dwtag  DW_TAG_variable, DW_AT_name("tmpVal")
	...
	.dwpsn	file "../FFT/rtGetInf.c",line 78,column 5,is_stmt
        MOV #-16 << #16, AC0 ; |78| 
        MOV AC0, dbl(*SP(#4)) ; |78| 
	.dwpsn	file "../FFT/rtGetInf.c",line 79,column 5,is_stmt
        MOV #0, AC0 ; |79| 
        MOV AC0, dbl(*SP(#6)) ; |79| 
	.dwpsn	file "../FFT/rtGetInf.c",line 80,column 5,is_stmt
        MOV dbl(*SP(#4)), AC0 ; |80| 
        MOV AC0, dbl(*SP(#2)) ; |80| 
	.dwendtag $C$DW$15

$C$L4:    
	.dwpsn	file "../FFT/rtGetInf.c",line 83,column 3,is_stmt
	.dwpsn	file "../FFT/rtGetInf.c",line 84,column 1,is_stmt
        AADD #9, SP
	.dwcfi	cfa_offset, 1
$C$DW$17	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$17, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$11, DW_AT_TI_end_file("../FFT/rtGetInf.c")
...
$C$DW$18	.dwtag  DW_TAG_subprogram, DW_AT_name("rtGetMinusInfF")
	...
	.dwattr $C$DW$18, DW_AT_TI_begin_file("../FFT/rtGetInf.c")
	...
	.dwpsn	file "../FFT/rtGetInf.c",line 91,column 1,is_stmt,address _rtGetMinusInfF

	.dwfde $C$DW$CIE, _rtGetMinusInfF
;*******************************************************************************
;* FUNCTION NAME: rtGetMinusInfF                                               *
;*                                                                             *
;*   Function Uses Regs : AC0,AC0,SP,M40,SATA,SATD,RDM,FRCT,SMUL               *
;*   Stack Frame        : Compact (No Frame Pointer, w/ debug)                 *
;*   Total Frame Size   : 4 words                                              *
...
_rtGetMinusInfF:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-3, SP
	.dwcfi	cfa_offset, 4
$C$DW$19	.dwtag  DW_TAG_variable, DW_AT_name("minfF")
	...
	.dwpsn	file "../FFT/rtGetInf.c",line 93,column 3,is_stmt
        MOV #-128 << #16, AC0 ; |93| 
        MOV AC0, dbl(*SP(#0)) ; |93| 
	.dwpsn	file "../FFT/rtGetInf.c",line 94,column 3,is_stmt
        MOV dbl(*SP(#0)), AC0 ; |94| 
	.dwpsn	file "../FFT/rtGetInf.c",line 95,column 1,is_stmt
        AADD #3, SP
	.dwcfi	cfa_offset, 1
$C$DW$20	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$20, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$18, DW_AT_TI_end_file("../FFT/rtGetInf.c")
...
$C$DW$21	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$21, DW_AT_name("wordH")
	.dwattr $C$DW$21, DW_AT_TI_symbol_name("_wordH")
	.dwattr $C$DW$21, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$21, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$22	.dwtag  DW_TAG_member
	.dwattr $C$DW$22, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$22, DW_AT_name("wordL")
	.dwattr $C$DW$22, DW_AT_TI_symbol_name("_wordL")
